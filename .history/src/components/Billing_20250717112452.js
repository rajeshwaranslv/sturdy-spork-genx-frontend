  ...
  return (
    <div className="container-fluid">
      ...
      <div className="table-section">
            ...
            <li key={item.id} className="item-row">
              ...
              <div className="item-status">
                <label className="switch">
                  <input type="checkbox" checked={item.served} onChange={() => toggleStatus(item.id)} />
                  <span className="slider round"></span>
                </label>
                <span className="status-label">{item.served ? 'Served' : 'Ordered'}</span>
              </div>
            </li>
          ))}
        </ul>
        ...
        <button className="generate-btn" onClick={completeOrder}>Generate Bill</button>
      </div>
    </div>
  );
}
