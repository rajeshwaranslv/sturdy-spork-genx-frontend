    ...
    <div className="container">
      ...
      <div className="waiter-card">
        <div className="waiter-left">
          <strong className="waiter-name">👨‍🍳 Waiter</strong>
      ...
      <ul className="order-list" style={{ marginTop: '20px' }}>
      ...
      <div style={{ marginTop: '20px', fontSize: '16px' }}>
            <p><strong style={{ fontSize: '32px' }}>Invoice Summary</strong></p>
        <p><strong>Subtotal:</strong> ₹{subtotal.toFixed(2)}</p>
        <p><strong>CGST (5%):</strong> ₹{cgst.toFixed(2)}</p>
        <p><strong>SGST (5%):</strong> ₹{sgst.toFixed(2)}</p>
        <p ><strong style={{ fontSize: '32px' }}>Total:</strong> ₹{total.toFixed(2)}</p>
      </div>

      <button className="footer-btn" onClick={completeOrder}>
        Complete Order
      </button>
    </div>
  );
